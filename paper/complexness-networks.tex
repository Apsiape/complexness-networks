...
Alignment and disjointness as stated are exactly necessary and
sufficient for the decoupled product ($0$ violations of the
biconditional over $124$ exhaustive and $150$ randomized setups);
the target-pair reference itself is exact unconditionally ($0$
failures over $4{,}176$ branches, including every counterexample).
